...
class Basic(base_tests.SimpleProtocol):
    """
    ...
    def getFlows(self,tableId):
        msg = ofp.message.flow_stats_request(table_id = tableId ,
                                     out_port = ofp.OFPP_ANY,
                                     out_group = ofp.OFPG_ANY,
                                     )
        response, pkt = self.controller.transact(msg)
        print(response.show())

    def getGroups(self):
        msg = ofp.message.group_desc_stats_request()
        response, pkt = self.controller.transact(msg)
        print(response.show())
